...
#data_csvs = ['./data/buf/dataset_1_sampled_aditional_value.csv', './data/buf/dataset_2_sampled_aditional_value.csv', './data/buf/dataset_3_sampled_aditional_value.csv', './data/buf/dataset_4_sampled_aditional_value.csv', './data/buf/dataset_5_sampled_aditional_value.csv']
#data_csvs = ['./data/buf/dataset_1_more_value.csv', './data/buf/dataset_2_more_value.csv', './data/buf/dataset_3_more_value.csv', './data/buf/dataset_4_more_value.csv', './data/buf/dataset_5_more_value.csv']
data_csvs = []

for i in range(1, 6):  # for each dataset
    for j in range(150, 1650, 150):  # for each count
        data_csvs.append(f'./data/buf/dataset_{i}_{j}_value.csv')

judge_csv = './data/buf/judge_aditional_value.csv'
...
for algorithm_name, algorithm in algorithms:
    for data_csv in data_csvs:
        ...
        results_df.to_csv('aditional_result.csv', index=False)
